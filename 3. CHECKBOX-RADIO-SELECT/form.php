...
<form action="./process.php" method="POST">
    <div class="mb-3">
        <select  class="form-control" name="choose_provice">
    ...
    <div class="mb-3">
        <input type="checkbox" class="form-control-check" id="html" value="HTML" name="checkbox_id[]">
        <label for="html" class="form-label">HTML</label>

        <input type="checkbox" class="form-control-check" id="css" value="CSS" name="checkbox_id[]">
        <label for="css" class="form-label">CSS</label>

        <input type="checkbox" class="form-control-check" id="js" value="JavaScript" name="checkbox_id[]">
        <label for="js" class="form-label">Javascript</label>

        <input type="checkbox" class="form-control-check" id="php" value="PHP" name="checkbox_id[]">
